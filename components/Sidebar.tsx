...
export default function Sidebar() {
  ...
  return (
    <>
      <div className="bg-[#2b2b2b] fixed top-18 left-40 h-[100vh] w-72 rounded-2xl p-6 text-center shadow-xl overflow-y-auto z-10 transition-all duration-300 ease-in-out flex flex-col justify-between">
